          ...
          <div className="max-w-6xl mx-auto">
              ...
              <Col xs={24} md={12} className="md:pr-6">
                ...
                <div className="md:hidden mb-6">
                  ...
                  <div className="flex items-center mb-4">
                    <Text style={{ marginRight: '16px' }}>Quantity:</Text>
                    <div className="flex items-center">
                      ...
                      <Text style={{ margin: '0 12px' }}>{quantity}</Text>
                      <Button
                        type="default"
                ...
                <div>
                  ...
                  >
                    ...
                    <Radio value="bank" className="flex items-center ml-8">
                      <div className="flex items-center">
                  ...
                  {paymentMethod === 'card' && (
                    <Form layout="vertical">
                      <Form.Item label="Card Number" className="mb-4">
                        <Input
                      ...
                      <div className="flex space-x-4">
                        <Form.Item label="Expiration Date" className="flex-1 mb-4">
                          <Input
                            placeholder="MM/YY"
                            size={isMobile() ? 'middle' : 'large'}
                          />
                        </Form.Item>
                        <Form.Item label="CVV" className="flex-1 mb-4">
                          <Input
                            placeholder="123"
                            size={isMobile() ? 'middle' : 'large'}
                          />
                      ...
                      <Form.Item className="mb-6">
                        ...
                        >
                          <Text type="secondary">Save card details</Text>
                        </Checkbox>
                      </Form.Item>
                    </Form>
                  )}
            ...
            <div className="md:hidden mt-6">
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between">
                  <Text>Subtotal</Text>
                  <Text type="danger">{subtotal.toLocaleString()} VND</Text>
                </div>
              </div>
              ...
              <Button type="primary" block size="large" style={{ height: '48px' }}>
                Checkout
              </Button>
