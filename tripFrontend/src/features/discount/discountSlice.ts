...
export const discountSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(discountThunk.getDiscountsAvailableByScheduleIds.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      ...
      .addCase(discountThunk.getNonDiscountableSchedules.fulfilled, (state, action) => {
        state.loading = false;
        state.discountsNonDiscountable = action.payload[0];
        state.pagination = action.payload[1] || ({} as TPagination);
        state.error = null;
      })
      .addCase(discountThunk.getNonDiscountableSchedules.rejected, (state, action) => {
        state.loading = false;
        state.error = String(action.error.message);
      })
      ...
      .addCase(discountThunk.assignProductSchedulesToDiscount.fulfilled, (state) => {
        state.loading = false;
        state.error = null;
      })
      .addCase(
